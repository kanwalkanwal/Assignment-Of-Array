...
let fruits: string[] =["Blueberry", "Banana", "Mango", "Orange"];
console.log(fruits);
...
let fruits_name: string[] =["Orange", "Gave", "Cherry", "Pineapple"];
...
let new_fruits: string[] =["Orange", "Mango", "Apple", "Cherry"];
...
let fruits00: string[] =["Rusberry", "strawberry", "Orange"];
...
let fruits0: string[]=["Orange","Pinaple","Graps","Apple"];
fruits0.splice(1,2);
console.log(fruits0);
...
let fruits01: string[]=["Berry", "Graps", "Mango",];
...
let fruits_list1: string[]=["Mango","strawberry","Berry"];
...
let fruitList3: string[]= ["Banama","Apple","cherry","Orange"];
